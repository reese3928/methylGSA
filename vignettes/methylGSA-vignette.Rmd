...
If group is "body" ("promoter"), only CpGs on gene body (promoters) will be 
considered. "body" ("promoter") is defined as CpGs whose gene group are 
"Body" or "1stExon" ("TSS1500" or "TSS200") according to the annotation in 
IlluminaHumanMethylation450kanno.ilmn12.hg19 or 
IlluminaHumanMethylationEPICanno.ilm10b4.hg19. By default, `group = "all"`, 
which means all CpGs are considered regardless of their gene group.
